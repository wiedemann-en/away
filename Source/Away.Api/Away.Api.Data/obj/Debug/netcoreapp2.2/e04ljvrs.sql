...
CREATE TABLE [dbo].[Ente] (
    ...
    CONSTRAINT [FK_Ente_Cliente_IdEnte] FOREIGN KEY ([IdEnte]) REFERENCES [dbo].[Cliente] ([IdCliente]) ON DELETE CASCADE,
    CONSTRAINT [FK_Ente_Proveedor_IdEnte] FOREIGN KEY ([IdEnte]) REFERENCES [dbo].[Proveedor] ([IdProveedor]) ON DELETE CASCADE,
...
CREATE TABLE [dbo].[Contacto] (
    ...
    [IdEnteRelacion] bigint NOT NULL,
    [AudFechaCreacion] datetime2 NOT NULL,
    [AudUsuarioCreacion] nvarchar(128) NOT NULL,
    [AudFechaModificacion] datetime2 NULL,
    [AudUsuarioModificacion] nvarchar(128) NULL,
    ...
    CONSTRAINT [FK_Contacto_Ente_IdEnteRelacion] FOREIGN KEY ([IdEnteRelacion]) REFERENCES [dbo].[Ente] ([IdEnte]) ON DELETE CASCADE
);
...
CREATE TABLE [dbo].[OrdenCabecera] (
    ...
    CONSTRAINT [FK_OrdenCabecera_Contacto_IdContacto] FOREIGN KEY ([IdContacto]) REFERENCES [dbo].[Contacto] ([IdContacto]) ON DELETE CASCADE,
...
ALTER TABLE [dbo].[OrdenDetalle] ADD CONSTRAINT [FK_OrdenDetalle_OrdenCabecera_IdOrdenCabecera] FOREIGN KEY ([IdOrdenCabecera]) REFERENCES [dbo].[OrdenCabecera] ([IdOrdenCabecera]) ON DELETE CASCADE;

GO

ALTER TABLE [dbo].[Ente] ADD CONSTRAINT [FK_Ente_Contacto_IdEnte] FOREIGN KEY ([IdEnte]) REFERENCES [dbo].[Contacto] ([IdContacto]) ON DELETE CASCADE;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20191217115223_V01', N'2.2.6-servicing-10079');
