...
CREATE TABLE [dbo].[EnteDocumentoTipo] (
    [IdTipo] bigint NOT NULL IDENTITY,
    [Activo] bit NOT NULL,
    [Codigo] nvarchar(50) NOT NULL,
    [Nombre] nvarchar(250) NOT NULL,
    CONSTRAINT [PK_EnteDocumentoTipo] PRIMARY KEY ([IdTipo])
);

GO

CREATE TABLE [dbo].[EnteDomicilioTipo] (
    [IdTipo] bigint NOT NULL IDENTITY,
    [Activo] bit NOT NULL,
    [Codigo] nvarchar(50) NOT NULL,
    [Nombre] nvarchar(250) NOT NULL,
    CONSTRAINT [PK_EnteDomicilioTipo] PRIMARY KEY ([IdTipo])
);

GO

CREATE TABLE [dbo].[EnteTelefonoTipo] (
    [IdTipo] bigint NOT NULL IDENTITY,
    [Activo] bit NOT NULL,
    [Codigo] nvarchar(50) NOT NULL,
    [Nombre] nvarchar(250) NOT NULL,
    CONSTRAINT [PK_EnteTelefonoTipo] PRIMARY KEY ([IdTipo])
);
...
CREATE TABLE [dbo].[Ente] (
    ...
    CONSTRAINT [FK_Ente_EnteDocumentoTipo_IdTipoDocumento] FOREIGN KEY ([IdTipoDocumento]) REFERENCES [dbo].[EnteDocumentoTipo] ([IdTipo]) ON DELETE NO ACTION
);
...
CREATE TABLE [dbo].[Contacto] (
    ...
    CONSTRAINT [FK_Contacto_Ente_IdEnteRelacion] FOREIGN KEY ([IdEnteRelacion]) REFERENCES [dbo].[Ente] ([IdEnte]) ON DELETE NO ACTION
);

GO

CREATE TABLE [dbo].[EnteTelefono] (
    ...
    CONSTRAINT [PK_EnteTelefono] PRIMARY KEY ([IdTelefono]),
    CONSTRAINT [FK_EnteTelefono_Ente_IdEnte] FOREIGN KEY ([IdEnte]) REFERENCES [dbo].[Ente] ([IdEnte]) ON DELETE CASCADE,
    CONSTRAINT [FK_EnteTelefono_EnteTelefonoTipo_IdTipo] FOREIGN KEY ([IdTipo]) REFERENCES [dbo].[EnteTelefonoTipo] ([IdTipo]) ON DELETE NO ACTION
);
...
CREATE TABLE [dbo].[OrdenCabecera] (
    ...
    CONSTRAINT [FK_OrdenCabecera_Contacto_IdContacto] FOREIGN KEY ([IdContacto]) REFERENCES [dbo].[Contacto] ([IdContacto]) ON DELETE NO ACTION,
...
CREATE TABLE [dbo].[EnteDomicilio] (
    ...
    CONSTRAINT [FK_EnteDomicilio_EnteDomicilioTipo_IdTipo] FOREIGN KEY ([IdTipo]) REFERENCES [dbo].[EnteDomicilioTipo] ([IdTipo]) ON DELETE NO ACTION
);
...
CREATE INDEX [IX_EnteTelefono_IdEnte] ON [dbo].[EnteTelefono] ([IdEnte]);

GO

CREATE INDEX [IX_EnteTelefono_IdTipo] ON [dbo].[EnteTelefono] ([IdTipo]);
...
VALUES (N'20191224160508_V01', N'2.2.6-servicing-10079');
