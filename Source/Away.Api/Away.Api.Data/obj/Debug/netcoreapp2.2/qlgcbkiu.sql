...
CREATE TABLE [dbo].[ArticuloSubTipo] (
    ...
    CONSTRAINT [FK_ArticuloSubTipo_ArticuloTipo_IdTipo] FOREIGN KEY ([IdTipo]) REFERENCES [dbo].[ArticuloTipo] ([IdTipo]) ON DELETE CASCADE
);
...
CREATE TABLE [dbo].[ClienteSubTipo] (
    ...
    CONSTRAINT [FK_ClienteSubTipo_ClienteTipo_IdTipo] FOREIGN KEY ([IdTipo]) REFERENCES [dbo].[ClienteTipo] ([IdTipo]) ON DELETE CASCADE
);
...
CREATE TABLE [dbo].[Empresa] (
    ...
    CONSTRAINT [FK_Empresa_Compania_IdCompania] FOREIGN KEY ([IdCompania]) REFERENCES [dbo].[Compania] ([IdCompania]) ON DELETE CASCADE
);
...
CREATE TABLE [dbo].[Provincia] (
    ...
    CONSTRAINT [FK_Provincia_Pais_IdPais] FOREIGN KEY ([IdPais]) REFERENCES [dbo].[Pais] ([IdPais]) ON DELETE CASCADE
);
...
CREATE TABLE [dbo].[Telefono] (
    ...
    CONSTRAINT [FK_Telefono_TelefonoTipo_IdTipo] FOREIGN KEY ([IdTipo]) REFERENCES [dbo].[TelefonoTipo] ([IdTipo]) ON DELETE CASCADE
);
...
CREATE TABLE [dbo].[Sucursal] (
    ...
    CONSTRAINT [FK_Sucursal_Compania_IdCompania] FOREIGN KEY ([IdCompania]) REFERENCES [dbo].[Compania] ([IdCompania]) ON DELETE CASCADE,
    CONSTRAINT [FK_Sucursal_Empresa_IdEmpresa] FOREIGN KEY ([IdEmpresa]) REFERENCES [dbo].[Empresa] ([IdEmpresa]) ON DELETE CASCADE
);
...
CREATE TABLE [dbo].[Partido] (
    ...
    CONSTRAINT [FK_Partido_Provincia_IdProvincia] FOREIGN KEY ([IdProvincia]) REFERENCES [dbo].[Provincia] ([IdProvincia]) ON DELETE CASCADE
);
...
CREATE TABLE [dbo].[Articulo] (
    ...
    CONSTRAINT [FK_Articulo_AlicuotaIva_IdAlicuotaIva] FOREIGN KEY ([IdAlicuotaIva]) REFERENCES [dbo].[AlicuotaIva] ([IdAlicuotaIva]) ON DELETE CASCADE,
    CONSTRAINT [FK_Articulo_ArticuloCategoria_IdCategoria] FOREIGN KEY ([IdCategoria]) REFERENCES [dbo].[ArticuloCategoria] ([IdCategoria]) ON DELETE CASCADE,
    ...
    CONSTRAINT [FK_Articulo_ArticuloLinea_IdLinea] FOREIGN KEY ([IdLinea]) REFERENCES [dbo].[ArticuloLinea] ([IdLinea]) ON DELETE CASCADE,
    CONSTRAINT [FK_Articulo_ArticuloMarca_IdMarca] FOREIGN KEY ([IdMarca]) REFERENCES [dbo].[ArticuloMarca] ([IdMarca]) ON DELETE CASCADE,
    CONSTRAINT [FK_Articulo_ArticuloRubro_IdRubro] FOREIGN KEY ([IdRubro]) REFERENCES [dbo].[ArticuloRubro] ([IdRubro]) ON DELETE CASCADE,
    CONSTRAINT [FK_Articulo_ArticuloSubTipo_IdSubTipo] FOREIGN KEY ([IdSubTipo]) REFERENCES [dbo].[ArticuloSubTipo] ([IdSubTipo]) ON DELETE CASCADE,
    CONSTRAINT [FK_Articulo_Sucursal_IdSucursal] FOREIGN KEY ([IdSucursal]) REFERENCES [dbo].[Sucursal] ([IdSucursal]) ON DELETE NO ACTION,
    CONSTRAINT [FK_Articulo_ArticuloTipo_IdTipo] FOREIGN KEY ([IdTipo]) REFERENCES [dbo].[ArticuloTipo] ([IdTipo]) ON DELETE CASCADE,
    CONSTRAINT [FK_Articulo_ArticuloUnidadMedida_IdUnidadMedida] FOREIGN KEY ([IdUnidadMedida]) REFERENCES [dbo].[ArticuloUnidadMedida] ([IdUnidadMedida]) ON DELETE CASCADE
);
...
CREATE TABLE [dbo].[Cliente] (
    ...
    CONSTRAINT [FK_Cliente_CondicionIva_IdCondicionIVA] FOREIGN KEY ([IdCondicionIVA]) REFERENCES [dbo].[CondicionIva] ([IdCondicionIva]) ON DELETE CASCADE,
    ...
    CONSTRAINT [FK_Cliente_DocumentoTipo_IdTipoDocumento] FOREIGN KEY ([IdTipoDocumento]) REFERENCES [dbo].[DocumentoTipo] ([IdTipo]) ON DELETE CASCADE
);
...
CREATE TABLE [dbo].[Usuario] (
    ...
    CONSTRAINT [FK_Usuario_Rol_IdRol] FOREIGN KEY ([IdRol]) REFERENCES [dbo].[Rol] ([IdRol]) ON DELETE CASCADE,
...
CREATE TABLE [dbo].[Localidad] (
    ...
    CONSTRAINT [FK_Localidad_Partido_IdPartido] FOREIGN KEY ([IdPartido]) REFERENCES [dbo].[Partido] ([IdPartido]) ON DELETE CASCADE
);
...
CREATE TABLE [dbo].[Domicilio] (
    ...
    CONSTRAINT [FK_Domicilio_Localidad_IdLocalidad] FOREIGN KEY ([IdLocalidad]) REFERENCES [dbo].[Localidad] ([IdLocalidad]) ON DELETE CASCADE,
    CONSTRAINT [FK_Domicilio_DomicilioTipo_IdTipo] FOREIGN KEY ([IdTipo]) REFERENCES [dbo].[DomicilioTipo] ([IdTipo]) ON DELETE CASCADE
);
...
VALUES (N'20191128221214_Initial', N'2.2.6-servicing-10079');
