...
namespace Away.Api.Site.Controllers
{
    ...
    [Route("localidades")]
    [ApiController]
    public class LocalidadController : AwayController
    {
        ...
        #region Constructors
        public LocalidadController(ILogger logger, ILocalidadService localidadService)
            : base(logger)
        {
        ...
        {
            var result = new ResultDto<List<LocalidadDto>>();
            try
            {
                var listDataDto = await _localidadService.GetActivesAsync();
                result.Data = listDataDto.Items;
            }
            catch (Exception ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
                result.AddError("Ocurrió un error al obtener el listado de localidades.");
            }
            return Ok(result);
        }
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            try
            {
                var listDataDto = await _localidadService.GetAsync();
                result.Data = listDataDto.Items;
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Get(long id)
        {
            ...
            try
            {
                result.Data = await _localidadService.GetByIdAsync(id);
            }
            catch (Exception ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
        ...
        public async Task<IActionResult> Delete(long id)
        {
            ...
            try
            {
                ...
                result.Data = await _localidadService.DeleteAsync(id);
            }
            catch (AwayException ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
        ...
        public async Task<IActionResult> Disable(long id)
        {
            ...
            try
            {
                ...
                result.Data = await _localidadService.DisableAsync(id);
            }
            catch (AwayException ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
        ...
        public async Task<IActionResult> Enable(long id)
        {
            ...
            try
            {
                ...
                result.Data = await _localidadService.EnableAsync(id);
            }
            catch (AwayException ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
