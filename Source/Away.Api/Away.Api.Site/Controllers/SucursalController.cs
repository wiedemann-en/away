...
namespace Away.Api.Site.Controllers
{
    ...
    [Route("sucursales")]
    [ApiController]
    public class SucursalController : AwayController
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            try
            {
                var listDataDto = await _sucursalService.GetAsync();
                result.Data = listDataDto.Items;
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Get(long id)
        {
            ...
            try
            {
                result.Data = await _sucursalService.GetByIdAsync(id);
            }
            catch (Exception ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
        ...
        public async Task<IActionResult> Delete(long id)
        {
            ...
            try
            {
                ...
                result.Data = await _sucursalService.DeleteAsync(id);
            }
            catch (AwayException ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
        ...
        public async Task<IActionResult> Disable(long id)
        {
            ...
            try
            {
                ...
                result.Data = await _sucursalService.DisableAsync(id);
            }
            catch (AwayException ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
        ...
        public async Task<IActionResult> Enable(long id)
        {
            ...
            try
            {
                ...
                result.Data = await _sucursalService.EnableAsync(id);
            }
            catch (AwayException ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
