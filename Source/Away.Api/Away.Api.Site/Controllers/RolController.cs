...
namespace Away.Api.Site.Controllers
{
    ...
    [Route("roles")]
    [ApiController]
    public class RolController : AwayController
    {
        ...
        #region Constructors
        public RolController(ILogger logger, IRolService rolService)
            : base(logger)
        {
        ...
        {
            var result = new ResultDto<List<RolDto>>();
            try
            {
                var listDataDto = await _rolService.GetActivesAsync();
                result.Data = listDataDto.Items;
            }
            catch (Exception ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
                result.AddError("Ocurrió un error al obtener el listado de roles.");
            }
            return Ok(result);
        }
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            try
            {
                var listDataDto = await _rolService.GetAsync();
                result.Data = listDataDto.Items;
            }
            catch (Exception ex)
            {
        ...
        {
            var result = new ResultDto<RolDto>();
            try
            {
                result.Data = await _rolService.GetByIdAsync(id);
            }
            catch (Exception ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]RolDto valueDto)
        {
            var result = new ResultDto<RolDto>();
            try
            {
                result.Data = await _rolService.CreateAsync(valueDto);
            }
            catch (Exception ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(long id, [FromBody]RolDto valueDto)
        {
            var result = new ResultDto<bool>();
            try
            {
                var modelExists = await _rolService.GetByIdAsync(id);
                if (modelExists == null)
                    throw new AwayException("No existe el registro que desea editar.");

                valueDto.Id = modelExists.Id;
                result.Data = await _rolService.UpdateAsync(valueDto);
            }
        ...
        public async Task<IActionResult> Delete(long id)
        {
            ...
            try
            {
                ...
                result.Data = await _rolService.DeleteAsync(id);
            }
            catch (AwayException ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
        ...
        public async Task<IActionResult> Disable(long id)
        {
            ...
            try
            {
                ...
                result.Data = await _rolService.DisableAsync(id);
            }
            catch (AwayException ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
        ...
        public async Task<IActionResult> Enable(long id)
        {
            ...
            try
            {
                ...
                result.Data = await _rolService.EnableAsync(id);
            }
            catch (AwayException ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
