...
{
    [AwayAuthorize]
    [Route("entedocumentotipos")]
    [ApiController]
    public class EnteDocumentoTipoController : AwayController
    {
        #region Private Attributes
        private readonly IEnteDocumentoTipoService _enteDocumentoTipoService;
        #endregion

        #region Constructors
        public EnteDocumentoTipoController(ILogger logger, IEnteDocumentoTipoService enteDocumentoTipoService)
            : base(logger)
        {
            _enteDocumentoTipoService = enteDocumentoTipoService;
        }
        #endregion
        ...
        public async Task<IActionResult> GetActives()
        {
            ...
            try
            {
                var listDataDto = await _enteDocumentoTipoService.GetActivesAsync();
        ...
        public async Task<IActionResult> Delete(long id)
        {
            ...
            try
            {
                ...
                result.Data = await _enteDocumentoTipoService.DeleteAsync(id);
            }
            catch (AwayException ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
        ...
        public async Task<IActionResult> Disable(long id)
        {
            ...
            try
            {
                ...
                result.Data = await _enteDocumentoTipoService.DisableAsync(id);
            }
            catch (AwayException ex)
            {
                _logger.Error(KOriginApp, ex.Message, ex);
