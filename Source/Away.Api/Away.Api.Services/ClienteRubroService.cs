...
{
    public class ClienteRubroService : ServiceBase<ClienteRubroDto, ClienteRubroModel>, IClienteRubroService
    {
        #region Constructors
        public ClienteRubroService(IUnitOfWork unitOfWork, ICurrentContext currentContext, IMapper mapper)
            : base(unitOfWork, currentContext, mapper)
        {
            _repository = unitOfWork.RegisterRepository<ClienteRubroRepository>();
        }
        #endregion
    }
}
