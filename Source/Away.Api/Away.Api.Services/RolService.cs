...
{
    public class RolService : ServiceBase<RolDto, RolModel>, IRolService
    {
        #region Constructors
        public RolService(IUnitOfWork unitOfWork, ICurrentContext currentContext, IMapper mapper)
            : base(unitOfWork, currentContext, mapper)
        {
            _repository = unitOfWork.RegisterRepository<RolRepository>();
        }
        #endregion
    }
}
