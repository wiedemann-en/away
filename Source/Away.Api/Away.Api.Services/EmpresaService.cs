...
{
    public class EmpresaService : ServiceBase<EmpresaDto, EmpresaModel>, IEmpresaService
    {
        #region Constructors
        public EmpresaService(IUnitOfWork unitOfWork, ICurrentContext currentContext, IMapper mapper)
            : base(unitOfWork, currentContext, mapper)
        {
            _repository = unitOfWork.RegisterRepository<EmpresaRepository>();
        }
        #endregion
    }
}
