...
{
    public class ContactoService : ServiceBase<ContactoDto, ContactoModel>, IContactoService
    {
        #region Constructors
        public ContactoService(IUnitOfWork unitOfWork, ICurrentContext currentContext, IMapper mapper)
            : base(unitOfWork, currentContext, mapper)
        {
            _repository = unitOfWork.RegisterRepository<ContactoRepository>();
        }
        #endregion
    }
}
