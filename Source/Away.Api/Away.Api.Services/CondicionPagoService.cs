...
{
    public class CondicionPagoService : ServiceBase<CondicionPagoDto, CondicionPagoModel>, ICondicionPagoService
    {
        #region Constructors
        public CondicionPagoService(IUnitOfWork unitOfWork, ICurrentContext currentContext, IMapper mapper)
            : base(unitOfWork, currentContext, mapper)
        {
            _repository = unitOfWork.RegisterRepository<CondicionPagoRepository>();
        }
        #endregion
    }
}
