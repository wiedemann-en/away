...
{
    public class EnteTelefonoTipoService : ServiceBase<EnteTelefonoTipoDto, EnteTelefonoTipoModel>, IEnteTelefonoTipoService
    {
        #region Constructors
        public EnteTelefonoTipoService(IUnitOfWork unitOfWork, ICurrentContext currentContext, IMapper mapper)
            : base(unitOfWork, currentContext, mapper)
        {
            _repository = unitOfWork.RegisterRepository<EnteTelefonoTipoRepository>();
        }
        #endregion
    }
}
