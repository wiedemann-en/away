...
{
    public class ArticuloRubroService : ServiceBase<ArticuloRubroDto, ArticuloRubroModel>, IArticuloRubroService
    {
        #region Constructors
        public ArticuloRubroService(IUnitOfWork unitOfWork, ICurrentContext currentContext, IMapper mapper)
            : base(unitOfWork, currentContext, mapper)
        {
            _repository = unitOfWork.RegisterRepository<ArticuloRubroRepository>();
        }
        #endregion
    }
}
