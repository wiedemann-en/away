...
{
    public class ArticuloSubTipoService : ServiceBase<ArticuloSubTipoDto, ArticuloSubTipoModel>, IArticuloSubTipoService
    {
        #region Constructors
        public ArticuloSubTipoService(IUnitOfWork unitOfWork, ICurrentContext currentContext, IMapper mapper)
            : base(unitOfWork, currentContext, mapper)
        {
            _repository = unitOfWork.RegisterRepository<ArticuloSubTipoRepository>();
        }
        #endregion
    }
}
