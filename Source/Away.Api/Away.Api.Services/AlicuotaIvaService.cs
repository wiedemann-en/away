...
{
    public class AlicuotaIvaService : ServiceBase<AlicuotaIvaDto, AlicuotaIvaModel>, IAlicuotaIvaService
    {
        #region Constructors
        public AlicuotaIvaService(IUnitOfWork unitOfWork, ICurrentContext currentContext, IMapper mapper)
            : base(unitOfWork, currentContext, mapper)
        {
            _repository = unitOfWork.RegisterRepository<AlicuotaIvaRepository>();
        }
        #endregion
    }
}
