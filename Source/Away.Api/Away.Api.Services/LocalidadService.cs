...
{
    public class LocalidadService : ServiceBase<LocalidadDto, LocalidadModel>, ILocalidadService
    {
        #region Constructors
        public LocalidadService(IUnitOfWork unitOfWork, ICurrentContext currentContext, IMapper mapper)
            : base(unitOfWork, currentContext, mapper)
        {
            _repository = unitOfWork.RegisterRepository<LocalidadRepository>();
        }
        #endregion
    }
}
